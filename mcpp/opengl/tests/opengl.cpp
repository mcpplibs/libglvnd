// libOpenGL.so.0, exercised through the module.
//
// Every FUNCTION and TYPE below comes from `import khronos.opengl;`. <GL/glcorearb.h> is
...
// exported name must resolve in libOpenGL.so.0).
//
