// libGLESv2.so.2, exercised through the module.
//
// Every FUNCTION and TYPE below comes from `import khronos.glesv2;`. <GLES3/gl32.h> is
...
// exported name must resolve in libGLESv2.so.2).
//
